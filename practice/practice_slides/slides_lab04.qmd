...
```{r}
#| output-location: slide
#| tbl-cap: "Adjusting for `Age` changes the estimated effect of `SmokeNow` on blood pressure (`BPSysAve`)"
...
```{r}
#| output-location: slide
#| tab-caption: "Comparison of the three models"
...
## [Proportion mediated]{.r-fit-text}
```{r}
